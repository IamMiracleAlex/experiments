...
class SignupFormTest(TestCase):
    ...
    def test_password_mismatch(self):
        ...
        self.assertEqual(form.errors['__all__'][0], "The password and password confirmation do not match")
    ...
    def test_password_lenth_validation(self):
        ...
        form = self.form_class(data=self.form_data)
        self.assertFalse(form.is_valid())
        self.assertEqual(form.errors['__all__'][0], "The password is too short, minimum of 6 characters")
